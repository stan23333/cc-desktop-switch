...
- [>] P1. Move Windows release packaging to Tauri/Rust artifacts.
  ...
  - [ ] P1.7. Verify the Windows Setup artifact on GitHub Actions or another Windows environment after the changes are committed and pushed.
...
- Verify P1.7 after the changes are committed and pushed, then continue to P2 only after Windows release artifacts have been confirmed.
